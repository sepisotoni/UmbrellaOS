...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_knowledge_entries_channel_id", "knowledge_entries", ["channel_id"]
    )
    op.create_index(
        "ix_knowledge_entries_discord_message_id",
        "knowledge_entries",
        ["discord_message_id"],
    )
    op.create_index(
        "ix_knowledge_entries_review_status", "knowledge_entries", ["review_status"]
    )
    ...
    op.create_index(
        "ix_knowledge_versions_knowledge_entry_id",
        "knowledge_versions",
        ["knowledge_entry_id"],
    )
...
def downgrade() -> None:
    op.drop_index(
        "ix_knowledge_versions_knowledge_entry_id", table_name="knowledge_versions"
    )
    op.drop_table("knowledge_versions")
    op.drop_index("ix_knowledge_entries_review_status", table_name="knowledge_entries")
    op.drop_index(
        "ix_knowledge_entries_discord_message_id", table_name="knowledge_entries"
    )
