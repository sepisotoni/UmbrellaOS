...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_server_metric_snapshots_server_id", "server_metric_snapshots", ["server_id"]
    )
    op.create_index(
        "ix_server_metric_snapshots_recorded_at",
        "server_metric_snapshots",
        ["recorded_at"],
    )
...
def downgrade() -> None:
    op.drop_index(
        "ix_server_metric_snapshots_recorded_at", table_name="server_metric_snapshots"
    )
    op.drop_index(
        "ix_server_metric_snapshots_server_id", table_name="server_metric_snapshots"
    )
