...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_moderation_reports_reported_user_id",
        "moderation_reports",
        ["reported_user_id"],
    )
    ...
    op.create_index(
        "ix_moderation_analyses_report_id", "moderation_analyses", ["report_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "related_report_id",
            sa.String(36),
            sa.ForeignKey("moderation_reports.id", ondelete="SET NULL"),
            nullable=True,
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_moderation_reports_reported_user_id", table_name="moderation_reports"
    )
