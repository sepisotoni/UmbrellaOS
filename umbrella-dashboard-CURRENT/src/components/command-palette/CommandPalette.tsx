...
export const CommandPalette: React.FC = () => {
  ...
  const items: PaletteItem[] = [
    ...
    { id: 'nav-topology', category: 'Navigation', title: 'Network Topology & Infrastructure Matrix', subtitle: 'Inspect EPYC/Ryzen nodes, latency ping map, and daemons', icon: Radio, action: () => { setActiveTab('topology'); setCommandPaletteOpen(false); } },
