    ...
    <div id="umbrella-overview-view" className="space-y-6">
        ...
        <div className="flex items-center gap-2">
          {onOpenBroadcastModal && (
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg border border-purple-500/40 bg-purple-950/40 px-3 py-1.5 text-xs font-semibold text-purple-200 hover:bg-purple-900/50 transition cursor-pointer"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div
          ...
          className="rounded-xl border border-[#1e1b4b] bg-[#0d1127] p-5 shadow-lg hover:border-purple-500/40 transition cursor-pointer group"
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-slate-400 uppercase tracking-wider font-mono">
              Servers Online
            </span>
            <div className="h-8 w-8 rounded-lg bg-purple-950/60 border border-purple-800/40 flex items-center justify-center text-purple-400 group-hover:scale-105 transition">
        ...
        <div
          ...
          className="rounded-xl border border-[#1e1b4b] bg-[#0d1127] p-5 shadow-lg hover:border-emerald-500/40 transition cursor-pointer group"
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-slate-400 uppercase tracking-wider font-mono">
              Players Online
        ...
        <div
          ...
          className="rounded-xl border border-[#1e1b4b] bg-[#0d1127] p-5 shadow-lg hover:border-rose-500/40 transition cursor-pointer group"
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-slate-400 uppercase tracking-wider font-mono">
              GrimAC Flags
        ...
        <div
          ...
          className="rounded-xl border border-[#1e1b4b] bg-[#0d1127] p-5 shadow-lg hover:border-amber-500/40 transition cursor-pointer group"
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-slate-400 uppercase tracking-wider font-mono">
              Pending Appeals
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Servers / Fleet Panel */}
        <div className="lg:col-span-2 rounded-xl border border-[#1e1b4b] bg-[#0d1127] p-5 shadow-xl">
          <div className="flex items-center justify-between pb-4 border-b border-[#1e1b4b]">
            <div className="flex items-center gap-2">
            ...
            {isLoading ? (
              ...
              servers.map((srv) => (
                <div
                  ...
                  className="flex items-center justify-between rounded-lg border border-[#1a1f42] bg-[#070914] p-3 hover:border-purple-500/40 transition cursor-pointer group"
                >
        ...
        {/* GrimAC Alerts Feed */}
        <div className="rounded-xl border border-[#1e1b4b] bg-[#0d1127] p-5 shadow-xl flex flex-col">
          <div className="flex items-center justify-between pb-4 border-b border-[#1e1b4b]">
            <div className="flex items-center gap-2">
            ...
            {isLoading ? (
              ...
              recentFlags.map((flag) => (
                <div
                  ...
                  className="rounded-lg border border-[#1a1f42] bg-[#070914] p-2.5 hover:border-rose-500/40 transition cursor-pointer"
                >
                  <div className="flex items-center justify-between">
