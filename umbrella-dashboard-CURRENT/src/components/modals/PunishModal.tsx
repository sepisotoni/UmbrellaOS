        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 font-mono text-xs overflow-y-auto flex-1">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full rounded-xl border border-[#1e1b4b] bg-[#070914] px-3.5 py-2.5 text-white placeholder-slate-500 focus:border-purple-500 focus:outline-none"
            />
          </div>
                  ...
                  <button
                    ...
                    className={`py-2 px-2 rounded-lg border text-center font-bold text-[11px] transition cursor-pointer ${
                      punishmentType === type
                        ...
                        : 'bg-[#070914] border-[#1e1b4b] text-slate-400 hover:text-white'
                    }`}
                  >
                    {type.replace('_', ' ')}
                  </button>
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full rounded-xl border border-[#1e1b4b] bg-[#070914] px-3.5 py-2.5 text-white focus:border-purple-500 focus:outline-none"
            />
            <div className="flex flex-wrap gap-1.5 mt-2">
              {presetReasons.map((p) => (
                <button
                  ...
                  type="button"
                  onClick={() => setReason(p)}
                  className="px-2 py-0.5 rounded bg-[#070914] border border-[#1e1b4b] text-[10px] text-slate-400 hover:text-purple-300 hover:border-purple-500/40 transition cursor-pointer"
                >
                  {p}
                </button>
              ))}
