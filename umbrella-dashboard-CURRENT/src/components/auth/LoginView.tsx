...
export const LoginView: React.FC = () => {
  ...
  return (
    <div
      ...
      className="min-h-screen w-full flex items-center justify-center p-4 bg-[#070914] text-slate-100 font-sans"
    >
      <div className="w-full max-w-md space-y-6">
        <DisconnectedBanner />

        <div className="rounded-2xl border border-[#1e1b4b] bg-[#0d1127]/90 p-8 shadow-2xl backdrop-blur-xl">
          {/* Header */}
          ...
          {!isTokenAuth ? (
            <div className="space-y-4">
              ...
              <div className="relative my-6 flex items-center justify-center">
                <div className="w-full border-t border-[#1e1b4b]" />
                <span className="bg-[#0d1127] px-3 text-[11px] font-mono uppercase text-slate-500 absolute">
                  or
                </span>
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 rounded-xl border border-[#1e1b4b] bg-[#070914] hover:bg-[#121638] px-4 py-2.5 text-xs font-medium text-purple-300 transition cursor-pointer"
              >
            ...
            <form onSubmit={handleDirectAuth} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full rounded-xl border border-[#1e1b4b] bg-[#070914] px-3.5 py-2.5 text-xs text-white placeholder-slate-600 focus:border-purple-500 focus:outline-none font-mono"
                  />
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 rounded-xl border border-[#1e1b4b] bg-[#070914] px-3 py-2.5 text-xs font-medium text-slate-400 hover:bg-[#121638] transition cursor-pointer"
                >
                  Back
                </button>
                <button
                  ...
                  className="flex-2 flex items-center justify-center gap-2 rounded-xl border border-purple-500/50 bg-purple-600 hover:bg-purple-500 px-3 py-2.5 text-xs font-bold text-white transition shadow-[0_0_15px_rgba(168,85,247,0.3)] disabled:opacity-50 cursor-pointer"
                >
          ...
          {/* Security notice */}
          <div className="mt-8 pt-4 border-t border-[#1e1b4b]/60 flex items-center justify-center gap-2 text-[11px] text-slate-500">
            <Shield className="h-3.5 w-3.5 text-purple-400/60" />
