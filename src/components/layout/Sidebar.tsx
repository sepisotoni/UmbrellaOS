...
export const Sidebar: React.FC<SidebarProps> = () => {
  ...
  return (
    <aside
      id="umbrella-sidebar"
      className={`shrink-0 h-full flex flex-col border-r select-none transition-all duration-200 bg-[#02040a] border-[#141d3d] text-slate-300 ${
    ...
    >
            ...
            return (
              <button
                ...
                className={`w-full flex items-center ${
                  ...
                  isActive
                    ? 'bg-[#13173d] text-indigo-200 border border-indigo-500/50 shadow-[0_0_12px_rgba(99,102,241,0.2)] font-semibold'
                    : 'text-slate-400 hover:bg-[#080f26] hover:text-slate-100 border border-transparent'
                }`}
              >
      ...
      <div className="shrink-0 border-t border-[#141d3d] bg-[#05091a]/80 p-3">
        {!sidebarCollapsed && currentUser && (
          <div className="mb-2.5 flex items-center justify-between px-1">
            <div className="flex items-center gap-2 min-w-0">
              <div className="h-7 w-7 rounded-full bg-indigo-950/80 border border-indigo-500/40 flex items-center justify-center font-bold text-indigo-300 text-xs shrink-0">
